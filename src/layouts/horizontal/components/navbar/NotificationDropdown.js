...
import { NotificationsAPI} from "@modules/artist/utility/API"
...
const NotificationDropdown = () => {
  ...
  const getNotifications = () => {
    NotificationsAPI.get('/user/notifications').then(({data}) => {
  ...
  const readAllNotifications = () => {
    NotificationsAPI.get('user/notification/read-all').then(() => getNotifications())
  }
