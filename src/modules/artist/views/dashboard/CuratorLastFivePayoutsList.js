...
class ArtistLastFiveInvoicesList extends Component {
  ...
  render () {
    ...
    return (
      <Fragment>
        <Breadcrumbs breadCrumbMainTitle={''} breadCrumbTitle={'Recent Payouts'} breadCrumbParent='' breadCrumbActive='' ></Breadcrumbs>
        <Row>
          <Col sm='12'>
            <DataTable
                ref={(ref) => { this.dataTableRef = ref }}
                uri={`web/curator/payouts/indexLastFiveForCurator/${this.props.curator.id}`}
