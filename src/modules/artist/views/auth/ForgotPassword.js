...
import {Row, Col, CardTitle, CardText, Form, FormGroup, Label, Input, Button, CardBody} from 'reactstrap'
...
const ForgotPassword = () => {
  ...
  const [captchaReqired, setcaptchaReqired] = useState(false)
              ...
              <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
                ...
                <Row>
                  <Col md={3}>
                    ...
                    />
                    {captchaReqired ? <small className="text-danger">Field is required</small> : '' }
                  </Col>
                </Row>
