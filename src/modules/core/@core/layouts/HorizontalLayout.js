    ...
    >
      ...
      >
        ...
        <div className='navbar-container d-flex content'>
          {navbar ? React.cloneElement(navbar, { setMenuVisibility, skin, setSkin, setIsRtl, isRtl, windowWidth, setMenuCollapsed, menuCollapsed }) : <NavbarComponent setMenuVisibility={setMenuVisibility} skin={skin} setSkin={setSkin} />}

          {/*{navbar ? navbar : <NavbarComponent skin={skin} setSkin={setSkin} setMenuVisibility={setMenuVisibility} />}*/}
        </div>
      </Navbar>
      {!isHidden ? (
