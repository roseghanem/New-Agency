...
const BasicInfoModal = (props) => {
  ...
  const [budget, setBudget] = useState(_.get(props, 'data.budget') ?? '')
  const [number_of_influencers, setNumber_of_influencers] = useState(_.get(props, 'data.number_of_influencers') ?? '')
  const [base_fees, setBase_fees] = useState(_.get(props, 'data.base_fees') ?? '')
  const [commission_fees, setCommission_fees] = useState(_.get(props, 'data.commission_fees') ?? '')
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <Col className={'mb-25'} sm={6} md={3}>
                        <Badge className={'w-100 p-1'} color={'light-secondary'}>
                          Campaign Amount
                          <p className={'mb-0'}>${budget > 0 ? budget : '0'}</p>
                        </Badge>
                      </Col>
                      <Col className={'mb-25'} sm={6} md={3}>
                        <Badge className={'w-100 p-1'} color={'light-secondary'}>
