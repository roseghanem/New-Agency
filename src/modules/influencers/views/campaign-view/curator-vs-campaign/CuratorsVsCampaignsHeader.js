...
import CuratorsVsCampaignsTabs from "./CuratorsVsCampaignsTabs"

const CuratorsVsCampaignsHeader = (props) => {
  ...
  return (
    <Navbar className='justify-content-end justify-content-md-between w-100' expand='md'>
      ...
      <Collapse isOpen={isOpen} navbar>
        <CuratorsVsCampaignsTabs />
      </Collapse>
    </Navbar>
  )
}

export default CuratorsVsCampaignsHeader
