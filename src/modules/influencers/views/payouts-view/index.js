    ...
    <div className='invoice-preview-wrapper'>
      <Row className='invoice-preview'>
        ...
        <Col xl={3} md={4} sm={12}>
          {
            !data.is_paid && (
              <PreviewActions setBudgetModalShow={setBudgetModalShow} data={data} />
            )
          }
        </Col>
      </Row>
        {budgetModalShow && <BasicInfoModal successCallback={getPayoutInfo} data={data} onClose={() => setBudgetModalShow(false)}/>}
    </div>
  ) : ''
  //     (
  //   <Alert color='danger'>
