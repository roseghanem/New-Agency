      ...
      <CardBody className='invoice-padding pb-0'>
        ...
        <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
          <div>
            ...
            <CanCall action='INFLUENCER_PAY_INVOICE'>
              {!data.is_paid && (
                <CardText className='mb-25'>
                  <div className='d-flex flex-wrap align-items-center'>
                    <Button.Ripple color='primary' onClick={() => setBudgetModalShow(true)}>
            ...
            <Row className='invoice-spacing'>
              <Col className='p-0 mt-xl-0 mt-2' lg='12'>
                ...
                <table>
                  ...
                  {
                    (data.attachment_link !== null && data.attachment_link !== 'undefined') ?
                          <tr>
